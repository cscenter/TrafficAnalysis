main: main.o Net_sniffer.o Statistic_analysis.o Parse_packet.o Signature_analysis.o Session.o
	g++ main.o Statistic_analysis.o Parse_packet.o Signature_analysis.o Net_sniffer.o Session.o -lpcap -o main 
