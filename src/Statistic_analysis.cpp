...
void Statistic_analysis::get_config(string filename) {
...
void Statistic_analysis::dbg_write_session_to_file(const Session& first, const Packages& second)const {
    string file_name = "build/result/ses" + to_string(dbg_processed_sessions_counter) + "_uplink.txt";
    ...
    out_up.close();
    file_name = "result/ses" + to_string(dbg_processed_sessions_counter) + "_downlink.txt";
    ...
    file_name = "result/ses" + to_string(dbg_processed_sessions_counter) + "_up_state.txt";
    ...
    file_name = "result/ses" + to_string(dbg_processed_sessions_counter) + "_down_state.txt";
    ...
    file_name = "result/ses" + to_string(dbg_processed_sessions_counter) + "_period_types.txt";
...
void Statistic_analysis::dbg_write_decision(string decision) const {
